<?php 
  ...
  elseif ($_SESSION['sessionu_type']=="Lecturer" || $_SESSION['sessionu_type']=="Student" ) {
        ...
        <?php
          ...
          ?>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
                    <div class="box8">
                        <img src="../uploads/users/<?php echo $row['u_img']?>">
                        <h3 class="title" style="background-color: blue;"><?php echo $row['f_name']?></h3>
                        <div class="box-content">
                            <ul class="icon">
                                <li><a href="<?php echo $url?>users/veiw_user.php"><i class="fa fa-eye " style="background-color: absolute;" ></i> </a> </li>
                            </ul>
                        </div>
                    </div>
                </div>

                          ...
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 bg-white " >
                            <div class="form-group">
                              ...
                              <?php
                                ...
                                while ($row=mysqli_fetch_array($query)) {
                                  ?>
                                  <option value="<?php echo $row['r_id'];?>"><?php echo $ll_id; ?></option>
                                  <?php
                                }
                              ?>
                              </select>
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 bg-white " >
                            <div class="form-group">
                              ...
                              <?php
                                ...
                                while ($row=mysqli_fetch_array($query)) {
                                  ?>
                                  <option value="<?php echo $row['r_id'];?>"><?php echo $uid; ?></option>
                                  <?php
                                }
                              ?>
                              </select>
...
if (isset($_POST['submit'])) {
  ...
  $sql3="INSERT INTO fine (cash_type,f_cash,f_type,rl_id,u_id) VALUES ('$cash_type','$f_cash','$f_type','$rl_id','$u_id')";

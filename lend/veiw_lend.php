    ...
    <div class="all-content-wrapper">
                              ...
                              while ($row=mysqli_fetch_array($query)) {
                                ?>
                                  <tr>
                                    ...
                                    <td>
                                      <a onclick="deletethis(this.id)" id="<?php echo $row['l_id'];?>" class="btn btn-danger">
                                        DELETE
                                      </a>
                                      <a href="add_lend2.php?viewid=<?php echo $row['l_id'];?>" class="btn btn-warning">
                                        View
                                      </a>
                                    </td>
                                  </tr>
       ...
       <script>
                 ...
                 $.confirm({
                     ...
                     buttons: {
                         confirm: function () {
                           location.href="delete_l_book.php?deleteid="+id;
                         },
                         cancel: function () {
                             alert(id)
                         }

...
<head>
  ...
  <style type="text/css">
    ...
    .box8 .title{background:#006DF0;font-size:20px;color:#fff}
    .box8:hover .box-content{opacity:1;transform:perspective(400px) rotateX(0)}
    .box8 .title{padding:5px 7px;border-radius:5px;font-weight:600;bottom:20px;left:20px;transition:all .9s ease 0s}
    .box8 .icon li a,.box9 .box-content,.box9 .icon li,.box9 img{transition:all .35s ease 0s}
    .box8:hover .title{bottom:-40px}
    .box8 .icon{list-style:none;padding:0;top:42%;left:0;right:0}
    .box8 .icon li a{display:block;line-height:40px;border-radius:50%;margin-right:7px; color: white; font-size: 22px;}
    .box9 .icon,.box9 .title{width:100%;font-size:22px}
    /*.box8 li :hover{background:#fff;color:#000}*/
    .box8 li:hover{
      background: #006DF0 ;
      transition: .5s;
    }
          ...
          ?>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
                    <div class="box8">
                        ...
                        <h3 class="title" ><?php echo $row['b_name']?></h3>
                        <div class="box-content">
                            <ul class="icon" style="    background: red;" >
                                  ...
                                  <?php 
                                    if ($row['quantity']>0){
                                      ?>
                                        ...
                                        <a href="<?php echo $url?>reserve/reserve_book.php?bid=<?php echo $row['b_id'];?>">

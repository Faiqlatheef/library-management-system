    ...
    <div class="all-content-wrapper">
                        ...
                        <h1>Users</h1>
                          <table class="table table-hover table-bordered">
                            ...
                            <?php
                              ...
                              $sql="SELECT * FROM book_type ORDER BY bt_id DESC";
                              ...
                              while ($row=mysqli_fetch_array($query)) {
                                ?>
                                  <tr>
                                    ...
                                    <td>
                                      <a onclick="deletethis(this.id)" id="<?php echo $row['bt_id'];?>" class="btn btn-danger">
                                        DELETE
                                      </a>
                                      <a href="edit_bt.php?editid=<?php echo $row['bt_id'];?>" class="btn btn-primary">
                                        EDIT
                                      </a>
                                    </td>
                                  </tr>
        ...
        <script>
                  ...
                  $.confirm({
                      ...
                      buttons: {
                          confirm: function () {
                            location.href="delete_bt.php?deleteid="+id;
                          },
                          cancel: function () {
                              alert(id)
                          }
